...
export const Cart = () => {
  const [formData, setFormData] = useState({
    ...
    unityValue: '88,99',
    totalValue: '88,99',
    itemsQuantity: 1 // aqui deve ser o tamanho do array de itens no carrinho.
  });
      ...
      <Form>
        ...
        <Row className="p-4">
          <Col className="p-1 d-flex align-items-center justify-content-center">
            ...
            >
              <p className="text-center fs-2">Ir para Checkout</p>
            </Button>
          </Col>
        </Row>
        <Row className="p-4 ">
          <Col className="p-1 d-flex align-items-center justify-content-center">
            <p className="text-center fs-2">
              {`SUBTOTAL = 
              R$ ${formData.totalValue}
              (${formData.itemsQuantity} Item)
              `}
            </p>
          </Col>
        </Row>
